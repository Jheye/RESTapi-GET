...
ShoppingList.create('bananas', 6);


Recipes.create('chocolate milk', ['cocoa', 'milk', 'sugar']);
Recipes.create('jack and coke', ['jack', 'coke', 'ice']);
Recipes.create('bourbon neat', ['bourbon', 'glass']);
Recipes.create('omlette', ['eggs', 'cheese', 'butter', 'chives']);
